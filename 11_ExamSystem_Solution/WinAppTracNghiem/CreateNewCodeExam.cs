...
{
    public partial class CreateNewCodeExam : Form
    {

        List<Question> Questions = new List<Question>();
        String course;
        WinAppTracNghiemContext context = new WinAppTracNghiemContext();
        public CreateNewCodeExam()
        {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("List questions is contaning " + course + " questions, can not add " + cboCourses.Text + " question");
                return;
            }
