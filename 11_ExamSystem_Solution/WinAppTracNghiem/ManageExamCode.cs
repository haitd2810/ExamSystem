...
{
    public partial class ManageExamCode : Form
    {
        WinAppTracNghiemContext context = new WinAppTracNghiemContext();
        public ManageExamCode()
        {
            InitializeComponent();
            LoadExamCode();
        ...
        {
            var data = context.ExamCodes.Select(e => new
            {
                Semester = e.Semester,
                Course = e.Course,
                Code = e.Code,
        ...
        {
            this.Hide();
            CreateNewCodeExam f = new CreateNewCodeExam();
            f.ShowDialog();
        }
        ...
        private void txtCode_TextChanged(object sender, EventArgs e)
        {
            ...
            ExamCode ex = context.ExamCodes.Where(ec => ec.Code.Equals(txtCode.Text)).FirstOrDefault();
        ...
        {
            DialogResult dialogResult = MessageBox.Show("Are you sure to delete this Question", "Alert", MessageBoxButtons.YesNo);
            if (dialogResult == DialogResult.Yes)
            {
                var Practive = context.Practices.Where(p => p.ExamCode.Equals(txtCode.Text)).FirstOrDefault();
                if (Practive != null)
                {
                    MessageBox.Show("There are student doing this test");
                    return;
                }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            Semester s = context.Semesters
                .Where(s => s.ExamCodes
                .Where(s => s.Code.Equals(txtCode.Text))
